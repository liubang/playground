...
constexpr bool is_signed_integer(DataType dt) {
    return dt == DataType::kInt8 || dt == DataType::kInt16 || dt == DataType::kInt32 ||
           dt == DataType::kInt64;
}

constexpr bool is_unsigned_integer(DataType dt) {
    return dt == DataType::kUint8 || dt == DataType::kUint16 || dt == DataType::kUint32 ||
           dt == DataType::kUint64;
}
...
constexpr bool is_floating_point(DataType dt) {
    return dt == DataType::kFloat || dt == DataType::kDouble || dt == DataType::kLongDouble;
}
...
constexpr bool is_variable_length(DataType dt) {
    return dt == DataType::kString || dt == DataType::kU16String || dt == DataType::kU32String ||
           dt == DataType::kBinary || dt == DataType::kArray || dt == DataType::kMap;
}
...
constexpr bool is_compound(DataType dt) {
    return dt == DataType::kTime || dt == DataType::kVersion || dt == DataType::kArray ||
           dt == DataType::kMap;
}
