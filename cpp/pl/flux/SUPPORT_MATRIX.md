...
| SQL 输入                        | 部分支持 | `import "sql"`、`sql.from(driver: "sqlite", dsn:, query:)` 可通过 SQLite C API 执行查询并物化为内存 `TableValue`；支持 null/int/float/text/blob-as-string 类型映射，后续 connector 抽象、逻辑计划、pushdown、MySQL 仍未实现                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
- 已有：`csv`，包含 `csv.from`
- 已有：`sql`，包含 `sql.from`；当前只支持 SQLite query 物化，connector / pushdown 见 `DATASOURCE_ARCHITECTURE.md`
