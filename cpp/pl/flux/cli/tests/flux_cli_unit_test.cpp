...
TEST(FluxCliTest, ExecutesCheckedInOpsDashboardQueryVariants) {
    ...
    const std::vector<ExampleCase> cases = {
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/cpu_top_windows.flux",
            .expected_output_fragments = {"Result: cpu_top_windows\n", "91", "82", "72"},
        },
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/cpu_distinct_hosts.flux",
            .expected_output_fragments = {"Result: cpu_distinct_hosts\n",
                                          "\"edge-1\"",
                                          "\"edge-2\""},
        },
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/cpu_gap_fill.flux",
            .expected_output_fragments = {"Result: cpu_gap_fill\n",
        ...
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/cpu_elapsed_by_host.flux",
            .expected_output_fragments = {"Result: cpu_elapsed_by_host\n",
        ...
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/cpu_usage_difference.flux",
            .expected_output_fragments = {"Result: cpu_usage_difference\n",
                                          "2024-05-01T10:00:40Z",
                                          "2024-05-01T10:01:05Z",
                                          "2024-05-01T10:01:10Z",
                                          "\"edge-1\"",
        ...
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/cpu_usage_derivative.flux",
            .expected_output_fragments = {"Result: cpu_usage_derivative\n",
                                          "2024-05-01T10:00:40Z",
                                          "2024-05-01T10:01:05Z",
                                          "2024-05-01T10:01:10Z",
                                          "\"edge-1\"",
        ...
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/latest_two_cpu_windows.flux",
            .expected_output_fragments = {"Result: latest_two_cpu_windows\n",
                                          "2024-05-01T10:01:05Z",
        ...
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/host_usage_pivot.flux",
            .expected_output_fragments = {"Result: host_usage_pivot\n",
                                          "2024-05-01T10:01:00Z",
        ...
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/monthly_cpu_calendar.flux",
            .expected_output_fragments = {"Result: monthly_cpu_calendar\n",
        ...
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/fleet_usage_union.flux",
            .expected_output_fragments =
                {"Result: fleet_usage\n", "\"cpu\"", "\"mem\"", "\"edge-2\"", "91"},
        },
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/edge1_cpu_rollup.flux",
            .expected_output_fragments = {"Result: edge1_cpu_rollup\n", "samples", "3", "226"},
        },
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/latest_west_cpu.flux",
            .expected_output_fragments =
                {"Result: latest_west_cpu\n", "\"edge-2\"", "\"us-west\"", "87"},
        },
        {
            .path = "cpp/pl/flux/examples/ops_dashboard/dual_region_latest.flux",
            .expected_output_fragments = {"Result: latest_west_cpu\n",
