...
check array '{"package":null,"imports":["array"],"results":[{"name":"_result","value":{"contains_two":true,"total":10,"doubled":[2,4,6,8],"all_positive":true,"any_large":true,"range":[0,2,4],"repeated":["x","x","x"],"length":4,"get":4,"get_default":-1,"slice":[2,3],"sorted":[3,2,1],"flat_mapped":[1,10,2,20],"found":3,"missing":-1,"found_index":2,"taken":[1,2],"dropped":[3,4],"reversed":[3,2,1],"unique":[1,2,3],"unfolded":[1,2,3],"scanned_last":6,"zipped":[{"left":"a","right":1},{"left":"b","right":2}],"enumerated":[{"index":0,"value":"a"},{"index":1,"value":"b"}],"table_host":"edge-1"}}],"last":{"contains_two":true,"total":10,"doubled":[2,4,6,8],"all_positive":true,"any_large":true,"range":[0,2,4],"repeated":["x","x","x"],"length":4,"get":4,"get_default":-1,"slice":[2,3],"sorted":[3,2,1],"flat_mapped":[1,10,2,20],"found":3,"missing":-1,"found_index":2,"taken":[1,2],"dropped":[3,4],"reversed":[3,2,1],"unique":[1,2,3],"unfolded":[1,2,3],"scanned_last":6,"zipped":[{"left":"a","right":1},{"left":"b","right":2}],"enumerated":[{"index":0,"value":"a"},{"index":1,"value":"b"}],"table_host":"edge-1"}}'
...
check syntax '{"package":"syntax_gallery","imports":["arr","regexp"],"results":[{"name":"_result","value":{"option_name":"syntax-gallery","option_member":true,"member":"edge-1","index_array":3,"index_object":"api","dict_cpu":10,"empty_object_len":0,"string_interp":"edge-1/api","numeric":{"add":3,"sub":2,"mul":8,"div":3.5,"mod":1,"unary":-3,"duration":"-5m","uint":"4u"},"comparisons":{"lt":true,"lte":true,"gt":true,"gte":true,"eq":true,"neq":true,"regex":true,"not_regex":true},"logical":true,"conditional":"present","closure_default":"svc-edge-1","functions":{"positional_call":14,"named_call":14,"closure_return":8,"higher_order_arg":12,"higher_order_nested":8,"object_function":"hot","indexed_function":6,"inline_function":3,"pipe_function":7,"fibonacci_6":8,"factorial_5":120,"max_value":9},"array_hof":[6,8],"table_hof":{"host":"edge-1","label":"node-edge-1","hot":true}}}],"last":{"option_name":"syntax-gallery","option_member":true,"member":"edge-1","index_array":3,"index_object":"api","dict_cpu":10,"empty_object_len":0,"string_interp":"edge-1/api","numeric":{"add":3,"sub":2,"mul":8,"div":3.5,"mod":1,"unary":-3,"duration":"-5m","uint":"4u"},"comparisons":{"lt":true,"lte":true,"gt":true,"gte":true,"eq":true,"neq":true,"regex":true,"not_regex":true},"logical":true,"conditional":"present","closure_default":"svc-edge-1","functions":{"positional_call":14,"named_call":14,"closure_return":8,"higher_order_arg":12,"higher_order_nested":8,"object_function":"hot","indexed_function":6,"inline_function":3,"pipe_function":7,"fibonacci_6":8,"factorial_5":120,"max_value":9},"array_hof":[6,8],"table_hof":{"host":"edge-1","label":"node-edge-1","hot":true}}}'
...
check timezone '{"package":null,"imports":["array","timezone"],"results":[{"name":"_result","value":{"utc_zone":"UTC","utc_offset":"0s","fixed_zone":"UTC","fixed_offset":"-8h","named_zone":"America/Los_Angeles","named_offset":"0s","fixed_window_start":"2023-12-31T08:00:00Z"}}],"last":{"utc_zone":"UTC","utc_offset":"0s","fixed_zone":"UTC","fixed_offset":"-8h","named_zone":"America/Los_Angeles","named_offset":"0s","fixed_window_start":"2023-12-31T08:00:00Z"}}'
