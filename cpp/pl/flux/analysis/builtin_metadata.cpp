...
const std::vector<BuiltinSignature>& signatures() {
    static const std::vector<BuiltinSignature> sigs = {
        ...
        Sig("",
            ...
            "dynamic",
            "Sum numeric values.",
            {Pipe("values"), Opt("column", "string", "_value")}),
        Sig("",
            "mean",
            "float",
        ...
        Sig("",
            ...
            {Req("tables", "record"), Req("on", "[string]"), Opt("method", "string")}),
        ...
        Sig("",
            "explain",
            "string",
            "Return the query plan explanation.",
            {Pipe("tables"),
             Opt("physical", "bool", "false"),
             Opt("optimized", "bool", "false"),
             Opt("pipeline", "bool", "false"),
             Opt("json", "bool", "false"),
             Opt("graph", "bool", "false")}),
        Sig("",
            "yield",
            "stream[A]",
        ...
        Sig("csv",
            ...
            {Opt("csv", "string"), Opt("file", "string"), Opt("mode", "string", "annotations")},
            true,
            true),
        Sig("sqlite",
            "from",
