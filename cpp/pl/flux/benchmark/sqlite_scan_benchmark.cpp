...
int run_benchmark(int argc, char** argv) {
    ...
    std::cout << "{"
              ...
              << "\"query_memory_used_bytes\":" << result_or->profile.memory.used_bytes << ","
              << "\"query_memory_peak_bytes\":" << result_or->profile.memory.peak_bytes << ","
              << "\"query_memory_limit_bytes\":" << result_or->profile.memory.limit_bytes << ","
