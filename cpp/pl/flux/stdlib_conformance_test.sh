...
check datasource '{"package":null,"imports":["datasource"],"results":[{"name":"_result","value":{"host":"edge-1","value":71.5,"region":"west"}}],"last":{"host":"edge-1","value":71.5,"region":"west"}}'
