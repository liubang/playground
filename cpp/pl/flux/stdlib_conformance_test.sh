...
check sql '{"package":null,"imports":["sql"],"results":[{"name":"_result","value":{"host":"edge-1","value":91.5,"note":null}}],"last":{"host":"edge-1","value":91.5,"note":null}}'
...
check universe_inspect '{"package":null,"imports":[],"results":[{"name":"_result","value":{"columns":["_time","host","region","_value"],"keys":["region"],"values":[10.0],"record_host":"edge-2","named_string":"<table bucket=\"inspect\" rows=2 tables=2>"}}],"last":{"columns":["_time","host","region","_value"],"keys":["region"],"values":[10.0],"record_host":"edge-2","named_string":"<table bucket=\"inspect\" rows=2 tables=2>"}}'
check universe_join '{"package":null,"imports":[],"results":[{"name":"_result","value":{"host":"edge-1","cpu":80.0,"mem":70.0}}],"last":{"host":"edge-1","cpu":80.0,"mem":70.0}}'
check universe_transform '{"package":null,"imports":[],"results":[{"name":"_result","value":{"row_host":"edge-1","row_service":"api","row_value":10.0,"row_score":11.0,"row_env":"prod","pivot_cpu":10.0,"pivot_mem":20.0,"union_rows":1}}],"last":{"row_host":"edge-1","row_service":"api","row_value":10.0,"row_score":11.0,"row_env":"prod","pivot_cpu":10.0,"pivot_mem":20.0,"union_rows":1}}'
check universe_window '{"package":null,"imports":[],"results":[{"name":"_result","value":{"elapsed":1,"difference":5.0,"derivative":5.0,"window_counts":[2,1],"aggregate_mean":12.5}}],"last":{"elapsed":1,"difference":5.0,"derivative":5.0,"window_counts":[2,1],"aggregate_mean":12.5}}'
