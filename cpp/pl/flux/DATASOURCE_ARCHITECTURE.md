...
- MySQL runtime：metadata、split manager 和 page source 共享 runtime 级 connection pool；
  rows/page、split count、pool idle size、split cache TTL/容量均可配置。
...
- MySQL 更大规模 scan：用 5M/10M fixture 继续观察 connection pool 后 read/execute/decode 的比例。
