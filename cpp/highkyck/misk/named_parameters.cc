...
inline static void init_arg(
    myconf& conf,
    boost::parameter::aux::tagged_argument<tag::object_store_memory, const int>
        arg) {
...
inline static void init_arg(
    myconf& conf,
    boost::parameter::aux::tagged_argument<tag::ignore_reinit_error, const bool>
        arg) {
...
inline static void init_arg(
    myconf& conf,
    boost::parameter::aux::tagged_argument<tag::address, const std::string>
        arg) {
