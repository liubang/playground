...
TEST(utils, map) {
  ...
  static_assert(std::is_same_v<
                playground::cpp::meta::Map<longList, std::add_pointer>::type,
                playground::cpp::meta::TypeList<char*, float*, int*, double*,
                                                char*>>);
  ASSERT_TRUE(true);
}
...
TEST(utils, filter) {
  ...
  static_assert(
      std::is_same_v<playground::cpp::meta::Filter<
                         longList, playground::cpp::meta::sizeLess4>::type,
...
TEST(utils, fold) {
  using longList =
      playground::cpp::meta::TypeList<char, float, int, double, char>;
  static_assert(playground::cpp::meta::Fold<
                    longList, std::integral_constant<size_t, 0>,
                    playground::cpp::meta::TypeSizeAcc>::type::value == 18);
}

TEST(utils, concat) {
  static_assert(std::is_same_v<
                playground::cpp::meta::Concat_t<
                    playground::cpp::meta::TypeList<int, double>,
...
TEST(utils, unique) {
  ...
  static_assert(
      std::is_same_v<
          playground::cpp::meta::Unique<longList>::type,
