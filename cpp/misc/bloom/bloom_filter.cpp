...
bool BloomFilter::contains(const tools::Binary& key, const tools::Binary& filter) const {
...
void BloomFilter::create(const tools::Binary* keys, std::size_t n, std::string* dst) const {
