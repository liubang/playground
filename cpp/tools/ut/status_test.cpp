...
TEST(Status, constructor) {
  auto ok = pl::tools::Status::NewOk("ok");
  EXPECT_TRUE(ok.isOk());
  ...
  auto not_found = pl::tools::Status::NewNotFound("xxx");
  ...
  auto corruption = pl::tools::Status::NewCorruption("xxx");
  ...
  auto not_supported = pl::tools::Status::NewNotSupported("xxx");
  ...
  auto invalid_argument =
      pl::tools::Status::NewInvalidArgument("xxx");
  ...
  auto io_error = pl::tools::Status::NewIOError("xxxx");
