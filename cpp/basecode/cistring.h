...
{
  static constexpr char to_upper_case(const char c) { return ('A' <= c && c <= 'Z') ? c + 32 : c; }
  ...
  static constexpr int compare(const char* str1, const char* str2, std::size_t count)
  {
  ...
  static constexpr const char* find(const char* s, std::size_t n, const char& a)
  {
